...
const LoginPage = () => {
  ...
  return (
    <>
      {/* Navbar Section */}
      <div className='px-4 h-14 w-full bg-light-bg border-b-2 border-main-purple1 border-opacity-10 flex justify-between items-center'>
        {/* Logo & Name */}
        <Link href={'/'}>
      ...
      {/* Login Section */}
      <div className='h-[92vh] bg-light-bg flex flex-col items-center justify-center'>
        <h1 className='font-semibold text-xl'>Sign in</h1>
        {/* Render the SuccessPage component if user is signed in */}
        <button
          className='w-full max-w-[300px] mt-2 py-1 h-14 bg-light-bg border-2 border-black rounded-md text-white flex items-center justify-center transition duration-300 ease-in-out hover:bg-blue-600 transform hover:-translate-y-0.5 hover:scale-105'
          onClick={handleLogin}
        >
